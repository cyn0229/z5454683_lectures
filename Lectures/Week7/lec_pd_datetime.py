...
#   representing a certain data
# ----------------------------------------------------------------------------

# One of the methods implemented by `dt.datetime` is called `now`, which
# returns an instance of `dt.datetime` representing the current data/time.

# Instance of `dt.datetime` with the current data/time
dt_now  = dt.datetime.now()

# This will produce a string representing the data/time in `dt_now`
#print(dt_now)
...
# store the data (year, month, day) and time (hour, minute, second,
...
# Add 12 hours to some data
#   - `start` will be the starting data
#   - `delta` will be a period of 12 hours
#   - `end` will be the ending data
...
# | %c        | Locale's appropriate data and time representation.            | Tue Aug 16 21:30:00 1988 |
...
#
## Selecting data ranges using strings
